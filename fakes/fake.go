...
func (s *FakeCollection) Find(params cfmgo.Params,
	result interface{}) (count int, err error) {
	count = TargetCount
...
func (s *FakeCollection) FindAndModify(selector interface{}, update interface{},
	result interface{}) (changeinfo *mgo.ChangeInfo, err error) {
	return
}

//UpsertID -
func (s *FakeCollection) UpsertID(id interface{},
	result interface{}) (changeInfo *mgo.ChangeInfo, err error) {
	var col []interface{}
...
// FindOne -
func (s *FakeCollection) FindOne(id string,
